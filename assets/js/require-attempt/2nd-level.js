define(['debouncing', 'matchMedia', 'matchMediaListener', 'blendingimg'],
function (debouncing, matchMedia, matchMediaListener, blendingimg) {
  'use strict';
  $(function() {
    var accEl = $('.tsr-product-colors li.acc');
    ...
    accEl.on('click', function(){
        ...
        if (section.hasClass(color)) {
           section.removeClass(color);
            $('.tsr-product-colors li.acc').removeClass('active');
        }
        else {
